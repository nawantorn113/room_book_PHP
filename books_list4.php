...
<body class="container p-5  ">
    ...
    <hr><br />
    <form action="books_list4.php" method="GET">
    ...
    <table border="1" cellspacing="0" cellpadding="5" class="table table-hover">
        ...
        <tbody>
            ...
            $sql = "SELECT *FROM books "
                ...
                . "WHERE books.bkin  AND books.bkstatus = '2' "
            ...
            ?>
                <tr>
                    <td>
                    <a href="update-process.php?id=<?php echo $row["id"]; ?>"class="btn btn-primary">Update</a>
                    <a href="javascript:bookstatus ('<?php echo $row['rmid']; ?>','<?php echo $row['bkin']; ?>',3)" class="btn btn-danger">Check out</a>
                    </td>
